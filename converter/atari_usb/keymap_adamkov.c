/*
Copyright 2019 Adam Kovesdi <adam.kovesdi.net@gmail.com>
...
#define KEYMAP( \
		...
		K1D,K1E,K1F,K20,K21,K22,K23,K24,K25,K26,K27,K28,        K60, K4B,K50,K4D, K6A,K6B,K6C,K4E,    \
		K2A,K2B,K2C,K2D,K2E,K2F,K30,K31,K32,K33,K34,K35,K36,                      K6D,K6E,K6F,        \
		    K38,            K39,                    K3A,                          K70,    K71,K72     \
) { \
...
const action_t fn_actions[] PROGMEM = {
	[0] = ACTION_MODS_TAP_KEY(MOD_LCTL, KC_ESC) // dual function key: TAP: Esc hold:LCTRL
};
...
`--------------------------------------------------------'                     |-----------| E |
       ...
       `---------------------------------------------'                         `---------------'
*/
    /* ANSI with adamkov tweaks */
    KEYMAP(
    F1,  F2,  F3,  F4,  F5,   F6,  F7,  F8,  F9,  F10,
    ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL,  GRV,BSPC,   HOME,     PGUP,    PAUS,RGUI,PSLS,PAST,
    TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC, ENT,DEL,    END,  UP ,PGDN,    P7,  P8,  P9,  PMNS,
    FN0 ,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,          INS,    LEFT,DOWN,RGHT,    P4,  P5,  P6,  PPLS,
    LSFT,BSLS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,RSFT,                                P1,  P2,  P3,
         LALT,     SPC,      RALT,                                                                   P0,       PDOT,PENT
		)
