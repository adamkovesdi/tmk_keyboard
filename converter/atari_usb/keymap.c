...
*/
    ...
    KEYMAP(
    F1,  F2,  F3,  F4,  F5,   F6,  F7,  F8,  F9,  F10,
    ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL,  GRV,BSPC,   PSCR,     END,     PGUP,PGDN,PSLS,PAST,
    TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC, ENT,DEL,    INS,  UP ,HOME,    P7,  P8,  P9,  PMNS,
    LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,          NUHS,   LEFT,DOWN,RGHT,    P4,  P5,  P6,  PPLS,
    LSFT,BSLS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,RSFT,                                P1,  P2,  P3,
         LALT,     SPC,      CAPS,                                                                   P0,       PDOT,PENT
		)
